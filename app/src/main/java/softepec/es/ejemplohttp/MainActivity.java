...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //crear el adaptador, y le pasas

        getBtn = findViewById(R.id.getPosts);
        ...
        listaV = findViewById(R.id.listV);
    ...
    private class OkHttpAync extends AsyncTask<Object, Void, Object> {
        ...
        protected void onPostExecute(Object result) {
            ...
            if (result != null) {
                ...
                posts = posts.fromJSON((String)result);

                Log.e(TAG, posts.getList().toString());

                posts.

                //al adaptador previamente creado yhjay que pasarle esa lista
                //notificar los cmabios
